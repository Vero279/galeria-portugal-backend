...
export interface ApiArtistEventArtistEvent extends Struct.CollectionTypeSchema {
  collectionName: 'artist_events';
  info: {
    displayName: 'Artist Event';
    pluralName: 'artist-events';
    singularName: 'artist-event';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiArtistQuizArtistQuiz extends Struct.CollectionTypeSchema {
  collectionName: 'artist_quizzes';
  info: {
    displayName: 'Artist Quiz';
    pluralName: 'artist-quizzes';
    singularName: 'artist-quiz';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::artist-quiz.artist-quiz'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    quiz_answers: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiArtistArtist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_discounts: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiArtworkReviewArtworkReview
  extends Struct.CollectionTypeSchema {
  collectionName: 'artwork_reviews';
  info: {
    displayName: 'Artwork Review';
    pluralName: 'artwork-reviews';
    singularName: 'artwork-review';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiArtworkArtwork extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wall_uploads: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    delivery_address: Schema.Attribute.String & Schema.Attribute.Required;
    delivery_city: Schema.Attribute.String & Schema.Attribute.Required;
    delivery_postal: Schema.Attribute.String;
    discount_amount: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    discount_code: Schema.Attribute.String;
    final_amount: Schema.Attribute.Decimal & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiUserDiscountUserDiscount
  extends Struct.CollectionTypeSchema {
  collectionName: 'user_discounts';
  info: {
    displayName: 'User Discount';
    pluralName: 'user-discounts';
    singularName: 'user-discount';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiWallUploadWallUpload extends Struct.CollectionTypeSchema {
  collectionName: 'wall_uploads';
  info: {
    displayName: 'Wall Upload';
    pluralName: 'wall-uploads';
    singularName: 'wall-upload';
  };
  options: {
    draftAndPublish: false;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::wall-upload.wall-upload': ApiWallUploadWallUpload;
